CLASS zcl_insert_data_gmgp DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
******** TABLA1 ********
    ...
    DELETE FROM ztb_acc_categ_gm.
    INSERT ztb_acc_categ_gm FROM TABLE @lt_acc_categ.
...
******** TABLA2 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_catego_gmgp.
    INSERT ztb_catego_gmgp FROM TABLE @lt_catego.
...
******** TABLA3 ********
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clientes_gm.
    INSERT ztb_clientes_gm FROM TABLE @lt_clientes.
...
******** TABLA4
    ...
    "Delete possible entries; insert new entries
    DELETE FROM ztb_clnts_lib_gm.
    INSERT ztb_clnts_lib_gm FROM TABLE @lt_clnts_lib.
...
******** TABLA5 ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    DELETE FROM ztb_libros_gmgp.
    INSERT ztb_libros_gmgp FROM TABLE @lt_libros.
